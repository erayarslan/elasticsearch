...
abstract class TopDocsCollectorContext extends QueryCollectorContext {
    ...
    static class CollapsingTopDocsCollectorContext extends TopDocsCollectorContext {
         ...
         */
        private CollapsingTopDocsCollectorContext(IndexSearcher indexSearcher,
                                                  Query query,
            ...
            this.topDocsCollector = collapseContext.createTopDocs(indexSearcher, query, sort, numHits, after);
    ...
    static TopDocsCollectorContext createTopDocsCollectorContext(SearchContext searchContext,
        ...
        if (searchContext.size() == 0) {
            ...
            return new CollapsingTopDocsCollectorContext(searchContext.searcher(), searchContext.query(),
                searchContext.collapse(), searchContext.sort(), numDocs, trackScores, searchContext.searchAfter());
        } else {
            int numDocs = Math.min(searchContext.from() + searchContext.size(), totalNumDocs);
